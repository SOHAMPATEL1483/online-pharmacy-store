...
<body>
	<div class="navbar bg-base-100 px-20">
		<div class="navbar-start">
			<a class="btn btn-ghost font-bold tracking-wide text-xl" href="/pharmacy-project/Index.html">QuickMeds</a>
		</div>
	...
	<div class="active">
		...
		try {
			...
			if (rs.next()) {
		%>
		<div class="card bg-base-100 shadow-lg w-fit flex-col items-center p-6 gap-4 mx-auto">
			...
			<p class="text-xl text-center"><%=rs.getString("fname")%></p>

			<p>
				<b>ID: </b><%=rs.getString("uid")%></p>
			<p>
				<b>Address: </b><%=rs.getString("address")%></p>
			<p>
				<b>Phone: </b><%=rs.getString("phno")%></p>
			<p>
				<b>Email: </b><%=rs.getString("email")%></p>
